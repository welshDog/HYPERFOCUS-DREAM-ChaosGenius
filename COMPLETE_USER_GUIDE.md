# 🧠💜 HYPERFOCUS DREAM - Complete User Guide
...
- **🎛️ ChaosGenius Dashboard**: Your central command center
...
```
Open VS Code → Press Ctrl+Shift+P → Type "Tasks: Run Task"
...
- **Health Monitor**: Built-in system monitoring

### **Step 3: Choose Your Energy Level**
The system adapts to your neurodivergent patterns:
- 🔥 **HIGH ENERGY**: All features active, hyperfocus mode
...
```
**Perfect for**: Hyperfocus sessions, brainstorming bursts
...
### **Important Files**
- **chaosgenius.db**: Main database (backup regularly!)
...
1. **Share Documentation**: Generated docs are investor-ready
...
*🧠 HYPERFOCUS DREAM Complete User Guide v1.0*  
*Built with 💜 for neurodivergent entrepreneurs*  
*May your chaos become your superpower*